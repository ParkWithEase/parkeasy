...
type userR struct {
	UseruuidCar  *userRUseruuidCarR
	AuthuuidAuth *userRAuthuuidAuthR
}

type userRUseruuidCarR struct {
	o *CarTemplate
}
...
func (t UserTemplate) setModelRels(o *models.User) {
	if t.r.UseruuidCar != nil {
		rel := t.r.UseruuidCar.o.toModel()
		rel.R.UseruuidUser = o
		rel.Useruuid = o.Useruuid
		o.R.UseruuidCar = rel
	}
...
func (o *UserTemplate) insertOptRels(ctx context.Context, exec bob.Executor, m *models.User) (context.Context, error) {
	...
	if o.r.UseruuidCar != nil {
		var rel0 *models.Car
		ctx, rel0, err = o.r.UseruuidCar.o.create(ctx, exec)
		if err != nil {
			return ctx, err
		}
		err = m.AttachUseruuidCar(ctx, exec, rel0)
		if err != nil {
			return ctx, err
		}
	}
...
func (m userMods) WithUseruuidCar(rel *CarTemplate) UserMod {
	return UserModFunc(func(o *UserTemplate) {
		o.r.UseruuidCar = &userRUseruuidCarR{
			o: rel,
		}
	})
}

func (m userMods) WithNewUseruuidCar(mods ...CarMod) UserMod {
	return UserModFunc(func(o *UserTemplate) {
		related := o.f.NewCar(mods...)

		m.WithUseruuidCar(related).Apply(o)
	})
}

func (m userMods) WithoutUseruuidCar() UserMod {
	return UserModFunc(func(o *UserTemplate) {
		o.r.UseruuidCar = nil
	})
}
