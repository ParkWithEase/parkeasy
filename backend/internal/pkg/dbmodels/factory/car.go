...
type carR struct {
	UseruuidUser *carRUseruuidUserR
}

type carRUseruuidUserR struct {
	o *UserTemplate
}
...
func (t CarTemplate) setModelRels(o *models.Car) {
	if t.r.UseruuidUser != nil {
		rel := t.r.UseruuidUser.o.toModel()
		rel.R.UseruuidCar = o
		o.Useruuid = rel.Useruuid
...
func ensureCreatableCar(m *models.CarSetter) {
	if m.Useruuid.IsUnset() {
		m.Useruuid = omit.From(random_uuid_UUID(nil))
	}
...
func (o *CarTemplate) create(ctx context.Context, exec bob.Executor) (context.Context, *models.Car, error) {
	...
	if o.r.UseruuidUser == nil {
		var ok bool
		rel0, ok = userCtx.Value(ctx)
		if !ok {
			CarMods.WithNewUseruuidUser().Apply(o)
		}
	}
	if o.r.UseruuidUser != nil {
		ctx, rel0, err = o.r.UseruuidUser.o.create(ctx, exec)
		if err != nil {
			return ctx, nil, err
		}
	}
	opt.Useruuid = omit.From(rel0.Useruuid)
...
// Set the model columns to this value
func (m carMods) Useruuid(val uuid.UUID) CarMod {
	return CarModFunc(func(o *CarTemplate) {
...
// Set the Column from the function
func (m carMods) UseruuidFunc(f func() uuid.UUID) CarMod {
	return CarModFunc(func(o *CarTemplate) {
		o.Useruuid = f
	})
}
...
// Clear any values for the column
func (m carMods) UnsetUseruuid() CarMod {
	return CarModFunc(func(o *CarTemplate) {
		o.Useruuid = nil
	})
}
...
// Generates a random value for the column using the given faker
// if faker is nil, a default faker is used
func (m carMods) RandomUseruuid(f *faker.Faker) CarMod {
	return CarModFunc(func(o *CarTemplate) {
...
func (m carMods) WithUseruuidUser(rel *UserTemplate) CarMod {
	return CarModFunc(func(o *CarTemplate) {
		o.r.UseruuidUser = &carRUseruuidUserR{
			o: rel,
		}
	})
}

func (m carMods) WithNewUseruuidUser(mods ...UserMod) CarMod {
	return CarModFunc(func(o *CarTemplate) {
		related := o.f.NewUser(mods...)

		m.WithUseruuidUser(related).Apply(o)
	})
}

func (m carMods) WithoutUseruuidUser() CarMod {
	return CarModFunc(func(o *CarTemplate) {
