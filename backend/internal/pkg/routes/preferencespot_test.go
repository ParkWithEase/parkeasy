...
// func (m *mockPreferenceSpotService) GetBySpotUUID(ctx context.Context, userID int64, spotID uuid.UUID) (bool, error) {
// 	args := m.Called(ctx, userID, spotID)
...
// 		spotUUID := uuid.New()
// 		srv.On("GetBySpotUUID", mock.Anything, testUserID, spotUUID).
// 			Return(true, nil).
// 			Once()
