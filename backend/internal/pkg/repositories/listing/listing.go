...
type Repository interface {
	...
	UnlistByUUID(ctx context.Context, listingID uuid.UUID) error
	UpdateByUUID(ctx context.Context, listingId uuid.UUID, listing *models.ListingCreationInput) error
}
